    ...
    public partial class ClientLocation : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 2, true, 1, new DateTime(2018, 3, 16, 0, 0, 0, 0, DateTimeKind.Unspecified), "NTRPL Reporting Tool", "Support", 81 },
                    { 1, true, 2, new DateTime(2017, 8, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "ILICO Hospital Management System", "In Force", 14 },
                    { 4, true, 2, new DateTime(2020, 1, 9, 0, 0, 0, 0, DateTimeKind.Unspecified), "Shital Fibers Limited ERP Reporting Tool", "Support", 15 },
                    { 3, true, 3, new DateTime(2019, 3, 16, 0, 0, 0, 0, DateTimeKind.Unspecified), "SSPL ERP Reporting Tool", "Support", 20 }
                });
