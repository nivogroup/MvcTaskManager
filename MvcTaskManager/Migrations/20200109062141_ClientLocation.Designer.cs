...
namespace MvcTaskManager.Migrations
{
    ...
    [Migration("20200109062141_ClientLocation")]
            ...
            modelBuilder.Entity("MvcTaskManager.Models.Project", b =>
                {
                    ...
                    b.HasData(
                        new { ProjectID = 1, Active = true, ClientLocationID = 2, DateOfStart = new DateTime(2017, 8, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), ProjectName = "ILICO Hospital Management System", Status = "In Force", TeamSize = 14 },
                        new { ProjectID = 2, Active = true, ClientLocationID = 1, DateOfStart = new DateTime(2018, 3, 16, 0, 0, 0, 0, DateTimeKind.Unspecified), ProjectName = "NTRPL Reporting Tool", Status = "Support", TeamSize = 81 },
                        new { ProjectID = 3, Active = true, ClientLocationID = 3, DateOfStart = new DateTime(2019, 3, 16, 0, 0, 0, 0, DateTimeKind.Unspecified), ProjectName = "SSPL ERP Reporting Tool", Status = "Support", TeamSize = 20 },
                        new { ProjectID = 4, Active = true, ClientLocationID = 2, DateOfStart = new DateTime(2020, 1, 9, 0, 0, 0, 0, DateTimeKind.Unspecified), ProjectName = "Shital Fibers Limited ERP Reporting Tool", Status = "Support", TeamSize = 15 }
                    );
                });
