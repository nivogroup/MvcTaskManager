    ...
    public partial class ApplicationDbContext : IdentityDbContext<ApplicationUser>
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Project>().HasData(
                new Project() { ProjectID = 1, ProjectName = "ILICO Hospital Management System", 
                    DateOfStart = Convert.ToDateTime("2017-8-1"), Active = true, ClientLocationID = 2, Status = "In Force", TeamSize = 14 },
                new Project() { ProjectID = 2, ProjectName = "NTRPL Reporting Tool", 
                    DateOfStart = Convert.ToDateTime("2018-3-16"), Active = true, ClientLocationID = 1, Status = "Support", TeamSize = 81 },
                new Project()
                {
                    ProjectID = 3,
                    ProjectName = "SSPL ERP Reporting Tool",
                    DateOfStart = Convert.ToDateTime("2019-3-16"),
                    Active = true,
                    ClientLocationID = 3,
                    Status = "Support",
                    TeamSize = 20
                ...
                {
                    ProjectID = 4,
                    ProjectName = "Shital Fibers Limited ERP Reporting Tool",
                    DateOfStart = Convert.ToDateTime("2020-1-09"),
                    Active = true,
                    ClientLocationID = 2,
                    Status = "Support",
                    TeamSize = 15
